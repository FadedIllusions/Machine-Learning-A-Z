...
# Draws an equidistant classification boundary between the chosen
# support vector (points) as with typical SVMs; however, KSVMs are 
# used when there's not any linear seperation within the data on 
...
# ([64, 4]  64+29 = 93 (Correct Predictions)
